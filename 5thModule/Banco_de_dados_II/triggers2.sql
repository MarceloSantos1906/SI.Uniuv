...
--
-- Host: localhost    Database: triggers2
-- ------------------------------------------------------
...
CREATE TABLE `compras` (
  ...
  KEY `fk_prod1_idx` (`produto`),
  CONSTRAINT `fk_prod1` FOREIGN KEY (`produto`) REFERENCES `produtos` (`id_produto`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vendas` (
  ...
  KEY `fk_prod2_idx` (`produto`),
  CONSTRAINT `fk_prod2` FOREIGN KEY (`produto`) REFERENCES `produtos` (`id_produto`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-17 19:06:08
